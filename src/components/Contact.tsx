...
export function Contact({ preselectedCourse }: ContactProps) {
  ...
  return (
    <section id="contact-section" className="py-24 bg-[#192153] text-white transition-colors duration-300 relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white">
            Connect With <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BA905E] to-[#D4A574]">Admissions</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5 space-y-8 text-left">
            ...
            <div className="space-y-4.5">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-md bg-[#BA905E]/10 border border-[#BA905E]/20 text-[#BA905E] shrink-0">
                  <Phone className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-[10px] font-mono text-slate-400 uppercase tracking-widest">Call admissions</p>
                  <a href="tel:+919823612171" className="text-sm font-bold text-white hover:text-[#BA905E] transition-colors">
                    +91 98236 12171
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@zelixai.in" className="text-sm font-bold text-white hover:text-[#BA905E] transition-colors">
                    info@zelixai.in
                  </a>
                </div>
              </div>
            ...
            <div className="rounded-lg border border-white/5 bg-[#0F1B2E] p-5 overflow-hidden shadow-sm relative group text-center lg:text-left">
              <div className="flex items-center justify-between mb-3.5">
                <span className="text-[10px] font-mono font-bold text-[#BA905E] uppercase tracking-wider flex items-center gap-1">
              ...
              <div className="h-28 rounded-md bg-[#0B1E2B] border border-white/5 relative flex items-center justify-center p-4">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-[#BA905E]/20 border border-[#BA905E] text-[#BA905E] flex items-center justify-center shadow-md animate-bounce">
                    <MapPin className="w-4 h-4 fill-[#BA905E]" />
                  </div>
                  <span className="mt-1 text-[10px] font-mono font-bold text-white bg-[#0F1B2E] px-2 py-0.5 rounded-md border border-white/10 shadow-sm">
                    Zelix AI Campus
                  </span>
                </div>
              </div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 w-full py-2 rounded-md text-center text-xs font-mono uppercase tracking-wider text-white bg-white/5 border border-white/10 hover:bg-white/10 transition-colors bloc[...]"
              >
          ...
          <div className="lg:col-span-7 w-full">
            <div className="rounded-lg border border-white/5 bg-[#0F1B2E] p-6 md:p-8 shadow-md">
              ...
              {success ? (
                <div className="py-12 text-center space-y-4">
                  <div className="w-16 h-16 rounded-md bg-[#BA905E]/10 text-[#BA905E] border border-[#BA905E]/20 flex items-center justify-center mx-auto shadow-sm">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-md text-xs font-mono uppercase tracking-wider border border-white/10 bg-white/5 hover:bg-white/10 text-white cursor-pointer transition-colors sh[...]"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5 text-left">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-md bg-[#0B1E2B] border border-white/10 focus:border-[#BA905E] focus:bg-[#192153] text-sm focus:outline-none transition-all text-white s[...]"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 rounded-md bg-[#0B1E2B] border border-white/10 focus:border-[#BA905E] focus:bg-[#192153] text-sm focus:outline-none transition-all text-white s[...]"
                      >
                        <option value="" className="bg-[#0F1B2E] text-white">-- General consultation --</option>
                        {courses.map((c) => (
                          <option key={c.id} value={c.title} className="bg-[#0F1B2E] text-white">
                            {c.title} (2 months)
                          </option>
                        ))}
                      </select>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-md bg-[#0B1E2B] border border-white/10 focus:border-[#BA905E] focus:bg-[#192153] text-sm focus:outline-none transition-all text-white sha[...]"
                    />
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                    <button
                      ...
                      type="submit"
                      disabled={submitting}
                      className="w-full sm:flex-1 py-4 rounded-md font-mono text-xs uppercase tracking-wider font-extrabold text-[#192153] bg-[#BA905E] hover:bg-[#c9a370] hover:shadow-[0_0_15px_r[...]"
                    >
                     ...
                     <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="py-4 px-6 rounded-md font-mono text-xs uppercase tracking-wider text-white border border-white/10 bg-white/5 hover:bg-white/10 transition-colors flex items-center[...]"
                    >
                      <MessageSquare className="w-5 h-5 text-[#BA905E] shrink-0" />
                      Chat on WhatsApp
                    </a>
                  </div>
                </form>
